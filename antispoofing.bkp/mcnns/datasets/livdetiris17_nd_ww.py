...
class LivDetIris17_ND_WW(Dataset):
    ...
    def __init__(self, dataset_path, ground_truth_path='', permutation_path='', iris_location='',
        ...
        super(LivDetIris17_ND_WW, self).__init__(dataset_path, output_path, iris_location, file_types, operation, max_axis)

        self.LIV_DET_TRAIN = os.path.join(PROJECT_PATH, '../extra/livdetiris17_nd_ww_splits/livdet-nd-ww-train.txt')
        self.LIV_DET_TEST = os.path.join(PROJECT_PATH, '../extra/livdetiris17_nd_ww_splits/livdet-nd-ww-test.txt')
        self.LIV_DET_UNKNOWN_TEST = os.path.join(PROJECT_PATH, '../extra/livdetiris17_nd_ww_splits/livdet-nd-ww-unknown_test.txt')
