...
class LivDetIris17_Clarkson(Dataset):
    '''
    Clarkson dataset
    '''
    def __init__(self, dataset_path, ground_truth_path='', permutation_path='', iris_location='',
        ...
        super(LivDetIris17_Clarkson, self).__init__(dataset_path, output_path, iris_location, file_types, operation, max_axis)

        self.ground_truth_path = ground_truth_path
        self.LIV_DET_TRAIN = os.path.join(PROJECT_PATH, '../extra/livdetiris17_clarkson_splits/trainset.csv')
        self.LIV_DET_TEST = os.path.join(PROJECT_PATH, '../extra/livdetiris17_clarkson_splits/testset.csv')
        self.LIV_DET_UNKNOWN_TEST = os.path.join(PROJECT_PATH, '../extra/livdetiris17_clarkson_splits/unknowntestset.csv')
        self.verbose = True
    ...
    def protocol_eval(self, fold=0, n_fold=5, train_size=0.5, output_path=''):
