...
class CommandLineParser(object):
    ...
    def parsing(self):
        ...
        group_c.add_argument('--fold', type=int, metavar='', default=0, choices=range(1,6),
                             help='(default=%(default)s).')

        group_c.add_argument('--round', type=str, default='',
                             help='(default=%(default)s).')
        ...
        group_c.add_argument('--meta_classification_from', type=str, default='scores', choices=['scores', 'labels'],
                             help='(default=%(default)s).')

        group_c.add_argument('--n_models', type=int, default=21,
                             help='(default=%(default)s).')

        group_c.add_argument('--step_algo', type=str, default='selection', choices=['selection', 'fusion'],
                             help='(default=%(default)s).')

        group_c.add_argument('--selection_algo', type=int, default=0,
                             help='(default=%(default)s).')

        group_d = self.parser.add_argument_group('Other options')

        group_d.add_argument('--operation', type=str, default='crop', choices=['none', 'crop', 'segment'],
                             help='(default=%(default)s).')

        group_d.add_argument('--max_axis', type=int, default=260,
                             help='(default=%(default)s).')
        ...
        group_b.add_argument("--n_points", type=int, default=1000, choices=[250, 500, 1000],
                             help="(default=%(default)s)")
